 ...
 * @author Ragavi
 */
public class UploadReport extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == reset) {
            textField1.setText("");
            textField2.setText("");
            catThyroid.setSelectedIndex(0);
            catBP.setSelectedIndex(0);
            catDiabetes.setSelectedIndex(0);
            catPcod.setSelectedIndex(0);
            catCholestrol.setSelectedIndex(0);
        }
        ...
        if (e.getSource() == sub) {
            ...
            try {
                ...
                String mySqlQuery = "INSERT INTO health_report(UserID, Username, Weight, Height, Thyroid, Diabetes, Cholestrol, BloodPressure, PCOD) "
                        + "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";

                PreparedStatement preparedStatement = myConn.prepareStatement(mySqlQuery);
                preparedStatement.setString(1, LoginSession.UserID);
                preparedStatement.setString(2, LoginSession.Username);
                preparedStatement.setInt(3, wt);
                preparedStatement.setInt(4, ht);
                preparedStatement.setString(5, ty);
                preparedStatement.setString(6, db);
                preparedStatement.setString(7, ch);
                preparedStatement.setString(8, bp);
                preparedStatement.setString(9, pcod);
                preparedStatement.execute();

                JOptionPane.showMessageDialog(this, "Hello, " + LoginSession.Username + " ...\nYou have uploaded you report Successfully!...");
